...
\par This report concerns the minimisation of multiple problem caracterisation (MIN-PCM).
We present first the state-of-the-art, then we describe the elements linked to the instance difficulty.
These elements allow us to propose heuristics for resolutions by exact and approach research.
Finally, we present the results obtained and make a comparison with those of the state-of-the-art.
\\\\

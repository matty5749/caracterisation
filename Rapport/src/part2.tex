...
La figure \ref{compGammaZoom} nous prouve également que aucune des deux heuristiques n'effectue un trie optimal.
...
\begin{definition}[Poids $P$ d'une paire d'entité]
...
\begin{tikzpicture}
\begin{axis}[
legend entries={rch10 trie par $\mathcal{T}$,rch10 par $\Gamma$,rch10 pmdaNoMaj,rch10 tabou},
